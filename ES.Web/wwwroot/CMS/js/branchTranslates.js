...
async function deleteTranslation(TranslationId, BranchId, element) {
    ...
    try {
        const DeleteUrl = `${baseUrl}EsAdmin/BranchesTranslates/Delete?translationId=${TranslationId}&branchId=${BranchId}`;
        // Send DELETE request
