...
namespace ES.Web.Areas.EsAdmin.Controllers
{
    [Area("EsAdmin")]
    [Authorize]
    public class PurchaseOrderInquiryController : Controller
    {
        private readonly PurchaseOrderInquiryRepository _InquiryRepository;
        private readonly RoleManager<IdentityRole> _roleManager;

        public PurchaseOrderInquiryController(
            PurchaseOrderInquiryRepository PurchaseOrderInquiryRepository,
            RoleManager<IdentityRole> roleManager)
        {
            _InquiryRepository = PurchaseOrderInquiryRepository;
        ...
        public async Task<IActionResult> ExportToExcel()
        {
            ...
            foreach (var r in requests)
            {
                ...
                worksheet.Cell(row, 4).Value = r.PurchaseOrderName ?? "";
